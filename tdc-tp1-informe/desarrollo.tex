...
% Para ello debemos definir con precisión dos cosas, la \textbf{fuente de informacion} y el \textbf{evento}, para luego calcular su probabilidad
% y de allí la entropía.
% 
% Para el caso de la fuente de información $S$ nuestros eventos son los protocolos de los mensajes que son capturados por la herramientas.